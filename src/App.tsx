...
interface ContentType {
  ...
  [key: string]: any; // Firestoreのデータを柔軟に扱うため
}

interface ContentContextType {
  EMPTY_CONTENT: ContentType;
  currentTargetContent: ContentType;
  setCurrentTargetContent: React.Dispatch<React.SetStateAction<ContentType>>;
  canEditContent: boolean;
  setCanEditContent: React.Dispatch<React.SetStateAction<boolean>>;
  prevContent: ContentType;
  setPrevContent: React.Dispatch<React.SetStateAction<ContentType>>;
...
function App() {
  const EMPTY_CONTENT: ContentType = {
    id: "",
    title: "",
    text: "",
    created_at: new Date(),
  ...
  const [currentTargetContent, setCurrentTargetContent] = useState<ContentType>(
    {
      ...EMPTY_CONTENT,
    }
  );
  const [canEditContent, setCanEditContent] = useState<boolean>(true);
  const [prevContent, setPrevContent] = useState<ContentType>({
    ...EMPTY_CONTENT,
  });
